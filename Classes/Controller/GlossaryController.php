...
class GlossaryController extends AbstractModuleController
{
    ...
    public function indexAction(): void
    {
        if (!$this->isConfigurationValid()) {
            $this->view->assign('isConfigurationValid', false);
            $this->view->render();
            return;
        }
    ...
    {
        if (!isset($this->configuration['sortByLanguage']) || empty($this->configuration['sortByLanguage'])) {
            return false;
        }
        if (empty($this->languagePairs)) {
            return false;
        }
        return true;
    }
